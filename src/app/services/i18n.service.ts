...
const AR: Record<string, string> = {
  ...
  'dash.continue': 'أكمل التعلّم',
  'dash.lessonNum': 'الدرس {n}',
  'dash.ofModule': '{p}% من هذه الوحدة',
  'dash.caughtUp': 'أنجزت كل الدروس 🎉',
  'dash.caughtUpTitle': 'أنت على أتمّ الاستعداد!',
  'dash.caughtUpSub': 'أكملت كل الدروس المتاحة. راقب الإعلانات لتعرف ما الجديد.',
  'dash.browseLessons': 'تصفّح الدروس',
  'dash.whereYouAre': 'أين وصلت',
  ...
  'quiz.next': 'التالي',
  'quiz.back': 'السابق',
  'quiz.answered': 'مجاب: {n} من أصل {t}',
  'quiz.pickOne': 'اختر إجابة واحدة للانتقال إلى السؤال التالي.',
  'quiz.progressAria': 'تقدّم الاختبار',
...
const EN: Record<string, string> = {
  ...
  'dash.lessonNum': 'Lesson {n}',
  'dash.ofModule': '{p}% of this module',
  'dash.caughtUp': 'All caught up 🎉',
  'dash.caughtUpTitle': "You're all set!",
  'dash.caughtUpSub': 'You finished every available lesson. Keep an eye on announcements for what comes next.',
  'dash.browseLessons': 'Explore lessons',
  'dash.whereYouAre': 'Where you are',
  ...
  'quiz.next': 'Next',
  'quiz.back': 'Back',
  'quiz.answered': 'Answered {n} of {t}',
  'quiz.pickOne': 'Pick one answer to move on.',
